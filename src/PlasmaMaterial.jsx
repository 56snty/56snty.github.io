...
const PlasmaMaterial = shaderMaterial(
  {
    ...
    uColorEnd: new THREE.Color('#DC143C'), // CRIMSON
    uMouse: new THREE.Vector2(0, 0)
  },
  // Vertex Shader (Shape deformation)
  `
    varying vec2 vUv;
    ...
    void main() {
      vUv = uv;
      // Complex noise calculation based on time
  ...
  `
    ...
    void main() {
      ...
      // Mix Black and Crimson based on distortion
      vec3 color = mix(uColorStart, uColorEnd, distort * (1.5 + sin(uTime)));
      
      // Add a scanline effect logic
